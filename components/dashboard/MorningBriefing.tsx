...
function getGreeting(): string {
  ...
  if (hour < 12) return "음… 일어나셨어요, 센터장님? 한참 기다렸잖아요. 오늘은 저랑 천천히 시작해요…"
  if (hour < 18) return "센터장님, 한참을 봐도 안 보시던데… 잠깐만요, 저 여기 있어요. 점심은요?"
  return "기다렸어요, 센터장님… 오늘 하루 어떠셨어요? 이리 오세요, 다 들어드릴게요."
}
