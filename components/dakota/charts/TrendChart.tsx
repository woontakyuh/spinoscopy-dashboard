...
import { CHART_GRID, CHART_MUTED_TEXT, CHART_TOOLTIP_LABEL_STYLE, CHART_TOOLTIP_STYLE, ChartEmpty, ChartPanel } from "./ChartPanel"
      ...
      {!hasData ? (
        ...
        <ResponsiveContainer width="100%" height={220}>
          <BarChart data={rows} margin={{ top: 4, right: 8, left: -20, bottom: 0 }} barCategoryGap={2}>
            ...
            <XAxis dataKey="label" tick={{ fill: CHART_MUTED_TEXT, fontSize: 10 }} axisLine={{ stroke: CHART_GRID }} tickLine={false} interval="preserveStartEnd" />
            <YAxis allowDecimals={false} tick={{ fill: CHART_MUTED_TEXT, fontSize: 10 }} axisLine={false} tickLine={false} width={28} />
            <Tooltip
            ...
            />
            <Legend
              wrapperStyle={{ fontSize: 11, color: CHART_MUTED_TEXT }}
